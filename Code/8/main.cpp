...
int main() {
  // FIX: Something is wrong with these
  std::println("\nSimpson eqn 1:");
  print_quadrature_table(eqn_1, 0.0, 1.0, IntegrationType::Simpson, 1e-40);

  std::println("\nMidpoint eqn 1:");
  print_quadrature_table(eqn_2, 0.0, 1.0, IntegrationType::Midpoint, 1e-10);
